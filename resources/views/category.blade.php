...
<div class="container">
    ...
    <div class="thumbnail">
        ...
        <div class="caption">
            ...
            <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                ...
                <input type="hidden" name="_token" value="V2EoIWIFv2Kl2caKxDpStd0oTTHWaiadNFGi4FA5">            </form>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="thumbnail">
        ...
        <img src="http://internet-shop.tmweb.ru/storage/products/samsung_j6.jpg" alt="iPhone X 64GB">
        <div class="caption">
